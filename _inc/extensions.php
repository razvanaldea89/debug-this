...
class Debug_This_Extensions{
	...
	public function constants_wordpress(){
		$constants = array('AUTOSAVE_INTERVAL' => AUTOSAVE_INTERVAL, 'CORE_UPGRADE_SKIP_NEW_BUNDLED' => CORE_UPGRADE_SKIP_NEW_BUNDLED, 'DISABLE_WP_CRON' => DISABLE_WP_CRON, 'EMPTY_TRASH_DAYS' => EMPTY_TRASH_DAYS, 'IMAGE_EDIT_OVERWRITE' => IMAGE_EDIT_OVERWRITE, 'MEDIA_TRASH' => MEDIA_TRASH, 'WPLANG' => WPLANG, 'WP_DEFAULT_THEME' => WP_DEFAULT_THEME, 'WP_CRON_LOCK_TIMEOUT' => WP_CRON_LOCK_TIMEOUT, 'WP_MAIL_INTERVAL' => WP_MAIL_INTERVAL, 'WP_POST_REVISIONS' => WP_POST_REVISIONS, 'WP_MAX_MEMORY_LIMIT' => WP_MAX_MEMORY_LIMIT, 'WP_MEMORY_LIMIT' => WP_MEMORY_LIMIT, 'APP_REQUEST' => APP_REQUEST, 'COMMENTS_TEMPLATE' => COMMENTS_TEMPLATE, 'DOING_AJAX' => DOING_AJAX, 'DOING_AUTOSAVE' => DOING_AUTOSAVE, 'DOING_CRON' => DOING_CRON, 'IFRAME_REQUEST' => IFRAME_REQUEST, 'IS_PROFILE_PAGE' => IS_PROFILE_PAGE, 'SHORTINIT' => SHORTINIT, 'WP_ADMIN' => WP_ADMIN, 'WP_BLOG_ADMIN' => WP_BLOG_ADMIN, 'WP_IMPORTING' => WP_IMPORTING, 'WP_INSTALLING' => WP_INSTALLING, 'WP_LOAD_IMPORTERS' => WP_LOAD_IMPORTERS, 'WP_NETWORK_ADMIN' => WP_NETWORK_ADMIN, 'WP_REPAIRING' => WP_REPAIRING, 'WP_SETUP_CONFIG' => WP_SETUP_CONFIG, 'WP_UNINSTALL_PLUGIN' => WP_UNINSTALL_PLUGIN, 'WP_USER_ADMIN' => WP_USER_ADMIN, 'XMLRPC_REQUEST' => XMLRPC_REQUEST, 'ABSPATH' => ABSPATH, 'WPINC' => WPINC, 'WP_LANG_DIR' => WP_LANG_DIR, 'WP_PLUGIN_DIR' => WP_PLUGIN_DIR, 'WP_PLUGIN_URL' => WP_PLUGIN_URL, 'WP_CONTENT_DIR' => WP_CONTENT_DIR, 'WP_CONTENT_URL' => WP_CONTENT_URL, 'WP_HOME' => WP_HOME, 'WP_SITEURL' => WP_SITEURL, 'WP_TEMP_DIR' => WP_TEMP_DIR, 'WPMU_PLUGIN_DIR' => WPMU_PLUGIN_DIR, 'WPMU_PLUGIN_URL' => WPMU_PLUGIN_URL, 'DB_CHARSET' => DB_CHARSET, 'DB_COLLATE' => DB_COLLATE, 'DB_HOST' => DB_HOST, 'DB_NAME' => DB_NAME, 'DB_PASSWORD' => DB_PASSWORD, 'DB_USER' => DB_USER, 'WP_ALLOW_REPAIR' => WP_ALLOW_REPAIR, 'CUSTOM_USER_TABLE' => CUSTOM_USER_TABLE, 'CUSTOM_USER_META_TABLE' => CUSTOM_USER_META_TABLE, 'ALLOW_SUBDIRECTORY_INSTALL' => ALLOW_SUBDIRECTORY_INSTALL, 'BLOGUPLOADDIR' => BLOGUPLOADDIR, 'BLOG_ID_CURRENT_SITE' => BLOG_ID_CURRENT_SITE, 'DOMAIN_CURRENT_SITE' => DOMAIN_CURRENT_SITE, 'DIEONDBERROR' => DIEONDBERROR, 'ERRORLOGFILE' => ERRORLOGFILE, 'MULTISITE' => MULTISITE, 'NOBLOGREDIRECT' => NOBLOGREDIRECT, 'PATH_CURRENT_SITE' => PATH_CURRENT_SITE, 'UPLOADBLOGSDIR' => UPLOADBLOGSDIR, 'SITE_ID_CURRENT_SITE' => SITE_ID_CURRENT_SITE, 'SUBDOMAIN_INSTALL' => SUBDOMAIN_INSTALL, 'SUNRISE' => SUNRISE, 'UPLOADS' => UPLOADS, 'WPMU_ACCEL_REDIRECT' => WPMU_ACCEL_REDIRECT, 'WPMU_SENDFILE' => WPMU_SENDFILE, 'WP_ALLOW_MULTISITE' => WP_ALLOW_MULTISITE, 'WP_CACHE' => WP_CACHE, 'COMPRESS_CSS' => COMPRESS_CSS, 'COMPRESS_SCRIPTS' => COMPRESS_SCRIPTS, 'CONCATENATE_SCRIPTS' => CONCATENATE_SCRIPTS, 'ENFORCE_GZIP' => ENFORCE_GZIP, 'FS_CHMOD_DIR' => FS_CHMOD_DIR, 'FS_CHMOD_FILE' => FS_CHMOD_FILE, 'FS_CONNECT_TIMEOUT' => FS_CONNECT_TIMEOUT, 'FS_METHOD' => FS_METHOD, 'FS_TIMEOUT' => FS_TIMEOUT, 'FTP_BASE' => FTP_BASE, 'FTP_CONTENT_DIR' => FTP_CONTENT_DIR, 'FTP_HOST' => FTP_HOST, 'FTP_LANG_DIR' => FTP_LANG_DIR, 'FTP_PASS' => FTP_PASS, 'FTP_PLUGIN_DIR' => FTP_PLUGIN_DIR, 'FTP_PRIKEY' => FTP_PRIKEY, 'FTP_PUBKEY' => FTP_PUBKEY, 'FTP_SSH' => FTP_SSH, 'FTP_SSL' => FTP_SSL, 'FTP_USER' => FTP_USER, 'WP_PROXY_BYPASS_HOSTS' => WP_PROXY_BYPASS_HOSTS, 'WP_PROXY_HOST' => WP_PROXY_HOST, 'WP_PROXY_PASSWORD' => WP_PROXY_PASSWORD, 'WP_PROXY_PORT' => WP_PROXY_PORT, 'WP_PROXY_USERNAME' => WP_PROXY_USERNAME, 'WP_HTTP_BLOCK_EXTERNAL' => WP_HTTP_BLOCK_EXTERNAL, 'WP_ACCESSIBLE_HOSTS' => WP_ACCESSIBLE_HOSTS, 'BACKGROUND_IMAGE' => BACKGROUND_IMAGE, 'HEADER_IMAGE' => HEADER_IMAGE, 'HEADER_IMAGE_HEIGHT' => HEADER_IMAGE_HEIGHT, 'HEADER_IMAGE_WIDTH' => HEADER_IMAGE_WIDTH, 'HEADER_TEXTCOLOR' => HEADER_TEXTCOLOR, 'NO_HEADER_TEXT' => NO_HEADER_TEXT, 'STYLESHEETPATH' => STYLESHEETPATH, 'TEMPLATEPATH' => TEMPLATEPATH, 'WP_USE_THEMES' => WP_USE_THEMES, 'SAVEQUERIES' => SAVEQUERIES, 'SCRIPT_DEBUG' => SCRIPT_DEBUG, 'WP_DEBUG' => WP_DEBUG, 'WP_DEBUG_DISPLAY' => WP_DEBUG_DISPLAY, 'WP_DEBUG_LOG' => WP_DEBUG_LOG, 'ADMIN_COOKIE_PATH' => ADMIN_COOKIE_PATH, 'ALLOW_UNFILTERED_UPLOADS' => ALLOW_UNFILTERED_UPLOADS, 'AUTH_COOKIE' => AUTH_COOKIE, 'AUTH_KEY' => AUTH_KEY, 'AUTH_SALT' => AUTH_SALT, 'COOKIEHASH' => COOKIEHASH, 'COOKIEPATH' => COOKIEPATH, 'COOKIE_DOMAIN' => COOKIE_DOMAIN, 'CUSTOM_TAGS' => CUSTOM_TAGS, 'DISALLOW_FILE_EDIT' => DISALLOW_FILE_EDIT, 'DISALLOW_FILE_MODS' => DISALLOW_FILE_MODS, 'DISALLOW_UNFILTERED_HTML' => DISALLOW_UNFILTERED_HTML, 'FORCE_SSL_ADMIN' => FORCE_SSL_ADMIN, 'FORCE_SSL_LOGIN' => FORCE_SSL_LOGIN, 'LOGGED_IN_COOKIE' => LOGGED_IN_COOKIE, 'LOGGED_IN_KEY' => LOGGED_IN_KEY, 'LOGGED_IN_SALT' => LOGGED_IN_SALT, 'NONCE_KEY' => NONCE_KEY, 'NONCE_SALT' => NONCE_SALT, 'PASS_COOKIE' => PASS_COOKIE, 'PLUGINS_COOKIE_PATH' => PLUGINS_COOKIE_PATH, 'SECURE_AUTH_COOKIE' => SECURE_AUTH_COOKIE, 'SECURE_AUTH_KEY' => SECURE_AUTH_KEY, 'SECURE_AUTH_SALT' => SECURE_AUTH_SALT, 'SITECOOKIEPATH' => SITECOOKIEPATH, 'TEST_COOKIE' => TEST_COOKIE, 'USER_COOKIE' => USER_COOKIE);
